...
namespace Online_Quiz_App.Tests
{
    ...
    public class UnitTest1
    {
        ...
        //        [TestMethod]
        //        public void Tlogin_AfterTeacherLogin_IsReteurningView()
        //        {

        //            var controller = new HomeController();
        //            //var admin = new Tbl_Admin();

        //            //var result = controller.tlogin(admin) as ViewResult;

        //            //var ab = result.ViewData.Model;
        //            var result =controller.Tlogin() as ViewResult;

        //            Assert.AreEqual("Tlogin",result.ViewName);
        //        }
